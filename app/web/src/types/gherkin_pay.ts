...
export type GherkinPay = {
  ...
  instructions: [
    {
      name: "addCondition";
      discriminator: [92, 223, 119, 30, 151, 178, 173, 245];
      accounts: [
        {
          name: "authority";
          writable: true;
    ...
    {
      name: "confirmWebhook";
      discriminator: [38, 142, 134, 35, 231, 3, 81, 95];
      accounts: [
        {
          name: "relayer";
          signer: true;
    ...
    {
      name: "crankOracle";
      discriminator: [133, 135, 250, 161, 77, 193, 0, 6];
      accounts: [
        {
          name: "payment";
        },
    ...
    {
      name: "crankTime";
      discriminator: [157, 161, 245, 201, 225, 117, 55, 95];
      accounts: [
        {
          name: "payment";
        },
    ...
    {
      name: "crankTokenGate";
      discriminator: [118, 228, 203, 129, 119, 185, 132, 194];
      accounts: [
        {
          name: "payment";
        },
    ...
    },
    {
      ...
      discriminator: [76, 242, 210, 200, 142, 165, 57, 98];
      accounts: [
        {
          name: "authority";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [244, 110, 2, 100, 161, 246, 68, 174];
      accounts: [
        {
          name: "payment";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [102, 228, 30, 207, 135, 86, 24, 181];
      accounts: [
        {
          name: "authority";
          signer: true;
    ...
    {
      name: "fundPayment";
      discriminator: [253, 134, 49, 76, 62, 0, 242, 82];
      accounts: [
        {
          name: "payer";
          writable: true;
    ...
    {
      name: "signMultisig";
      discriminator: [115, 62, 45, 2, 49, 18, 137, 212];
      accounts: [
        {
          name: "signer";
          signer: true;
  ...
  accounts: [
    {
      name: "conditionAccount";
      discriminator: [237, 200, 74, 27, 169, 73, 95, 187];
    },
    {
      name: "paymentAgreement";
      discriminator: [55, 21, 232, 136, 243, 133, 124, 251];
    }
  ];
  events: [
    {
      name: "conditionAdded";
      discriminator: [192, 142, 9, 230, 169, 81, 165, 64];
    },
    {
      name: "conditionMet";
      discriminator: [162, 157, 80, 222, 211, 200, 90, 236];
    },
    {
      name: "milestoneAdvanced";
      discriminator: [77, 149, 170, 109, 217, 217, 16, 119];
    },
    {
      name: "multisigApproval";
      discriminator: [248, 224, 205, 32, 153, 235, 176, 35];
    },
    {
      name: "paymentCancelled";
      discriminator: [137, 140, 226, 59, 55, 152, 253, 179];
    },
    {
      name: "paymentCompleted";
      discriminator: [157, 184, 146, 198, 243, 50, 113, 174];
    },
    {
      name: "paymentCreated";
      discriminator: [174, 8, 230, 213, 220, 35, 198, 204];
    },
    {
      name: "paymentFunded";
      discriminator: [81, 134, 131, 50, 156, 141, 224, 70];
    },
    {
      name: "paymentReleased";
      discriminator: [160, 132, 155, 232, 46, 254, 69, 219];
    }
  ];
  errors: [
    {
